        ...
        <div class="b-ideas__items">
            <div class="b-ideas__item">
                <div class="b-ideas__item-img">
                    <img src="<?php echo wp_get_attachment_image_url( carbon_get_theme_option( 'catalogue_projects_image' ), 'full'); ?>" alt="">
                </div>
                <div class="b-ideas__item-wrap">
                    <div class="b-ideas__item-detail">
                        <div class="b-ideas__item-title"><?php echo carbon_get_theme_option( 'catalogue_projects_title' ); ?></div>
                        <div class="b-ideas__item-text"><?php echo carbon_get_theme_option( 'catalogue_projects_content' ); ?></div>
                    </div>
                    <?php /*
